...
In previous [Project 6](https://github.com/BosunEnoch7/DevOPS-Projects/tree/main/Project%206) you implemented a WordPress-based solution that is ready to be filled with content and can be used as a full-fledged website or blog. Moving further we will add some more value to our solutions that your DevOps team could utilize. We want to introduce a set of DevOps tools that will help our team in day-to-day activities in managing, developing, testing, deploying and monitoring different projects.
...
![Task 7](./Images/1_TuBk--fnY6ZDTbEKAfADRg.png)
...
```
![Task 7](./Images/Task%207.1.png)
![Task 7](./Images/Task%207.2.png)
![Task 7](./Images/Task%207.3.png)
![Task 7](./Images/Task%207.4.png)
...
To check your **subnet cidr** – open your EC2 details in the AWS web console and locate the ‘Networking’ tab and open a Subnet link:
 ![Task 7](./Images/Task%207.6.png)
 ![Task 7](./Images/Task%207.7.png)
...
sudo exportfs -arv
```
 ![Task 7](./Images/Task%207.9.png)
6.	Check whih port is used by NFS and open it using Security Groups (add new Inbound Rule)
``rpcinfo -p | grep nfs``
 ![Task 7](./Images/Task%207.10.png)
**Important note:** In order for NFS server to be accessible from your client, you must also open following ports: TCP 111, UDP 111, TCP 2049 and UDP 2049
![Task 7](./Images/Task%207.11.png)
...
![Task 7](./Images/Task%207.12.png)
![Task 7](./Images/Task%207.13.png)
![Task 7](./Images/Task%207.14.png)
![Task 7](./Images/Task%207.15.png)
...
```
![Task 7](./Images/Task%207.17.png)
![Task 7](./Images/Task%207.18.png)
![Task 7](./Images/Task%207.19.png)
![Task 7](./Images/Task%207.20.png)
...
![Task 7](./Images/Task%207.21.png)
![Task 7](./Images/Task%207.22.png)
![Task 7](./Images/Task%207.23.png)
7.	Locate the log folder for Apache on the Web Server and mount it to NFS server’s export for logs. Repeat step №4 to make sure the mount point will persist after reboot.
![Task 7](./Images/Task%207.24.png)

8.	Fork the tooling source code from [HERE](https://github.com/BosunEnoch7/tooling) to your Github account. (Learn how to fork a repo [Here](https://youtu.be/f5grYMXbAV0?si=rbyxmmQ8b4Wunyba))
![Task 7](./Images/Task%207.25.png)
9.	Deploy the tooling website’s code to the Webserver. Ensure that the html folder from the repository is deployed to `/var/www/html`
![Task 7](./Images/Task%207.26.png)
...
![Task 7](./Images/Task%207.27.png)
![Task 7](./Images/Task%207.28.png)

Apply `tooling-db.sql` script to your database using this command 
```
mysql -h <databse-private-ip> -u <db-username> -p <db-pasword> < tooling-db.sql
```
![Task 7](./Images/Task%207.29.png)
![Task 7](./Images/Task%207.30.png)

**Important**
You do NOT need to create the user manually anymore because:

`tooling-db.sql already created the admin user`

11.	Open the website in your browser ```http://<Web-Server-Public-IP-Address-or-Public-DNS-Name>/index.php``` and make sure you can login into the websute with myuser user.

 ![Task 7](./Images/Task%207.31.png)

 ![Task 7](./Images/Task%207.32.png)

 ![Task 7](./Images/Task%207.33.png)
