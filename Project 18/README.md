...
```
Terraform expects that both S3 bucket and DynamoDB resources are already created before we configure the backend. Run `terraform plan ` and `terraform apply` to provision resources.

![Task18](./Images/Task%2018.1.png)
...
![Task18](./Images/Task%2018.2.png)

4. Verify the changes

- Open the AWS console now to see what happened you should be able to see the following:
- `tfstatefile` is now inside the S3 bucket. 
![Task18](./Images/Task%2018.3.png)
![Task18](./Images/Task%2018.4.png)
![Task18](./Images/Task%2018.5.png)
- DynamoDB table which we create has an entry which includes state file status. 
![Task18](./Images/Task%2018.6.png)

5. Add the code below to `output.tf` file
...
For repetitive blocks of code you can use [dynamic blocks](https://www.terraform.io/docs/language/expressions/dynamic-blocks.html) in Terraform, to get to know more how to use them – watch [this video](https://www.terraform.io/docs/language/expressions/dynamic-blocks.html).
Refactor Security Groups creation with dynamic blocks.
...
```
![Task18](./Images/Task%2018.9.png)
![Task18](./Images/Task%2018.10.png)
...
![Task18](./Images/Task%2018.11.png)
![Task18](./Images/Task%2018.12.png)
![Task18](./Images/Task%2018.13.png)
![Task18](./Images/Task%2018.14.png)
...
![Task18](./Images/Task%2018.15.png)
...
![Task18](./Images/Task%2018.16.png)
...
```
![Task18](./Images/Task%2018.17.png)
...
![Task18](./Images/Task%2018.18.png)